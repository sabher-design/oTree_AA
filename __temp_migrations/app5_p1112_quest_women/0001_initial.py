# Generated by Django 2.2.12 on 2024-03-11 12:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='app5_p1112_quest_women_group', to='otree.Session')),
            ],
            options={
                'db_table': 'app5_p1112_quest_women_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='app5_p1112_quest_women_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'app5_p1112_quest_women_subsession',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('smiley1', otree.db.models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], null=True, verbose_name='To tournament participant 1 (female) ')),
                ('smiley2', otree.db.models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], null=True, verbose_name='To tournament participant 2 (female) ')),
                ('smiley3', otree.db.models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], null=True, verbose_name='To tournament participant 3 (female) ')),
                ('smiley4', otree.db.models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], null=True, verbose_name='To tournament participant 4 (male)  ')),
                ('smiley5', otree.db.models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], null=True, verbose_name='To tournament participant 5 (male)  ')),
                ('smiley6', otree.db.models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], null=True, verbose_name='To tournament participant 6 (male)  ')),
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app5_p1112_quest_women.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='app5_p1112_quest_women_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='app5_p1112_quest_women_player', to='otree.Session')),
                ('subsession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app5_p1112_quest_women.Subsession')),
            ],
            options={
                'db_table': 'app5_p1112_quest_women_player',
            },
        ...
        migrations.AddField(
            model_name='group',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app5_p1112_quest_women.Subsession'),
        ),
    ]
