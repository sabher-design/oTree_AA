...
class Player(BasePlayer):
    ...
    ingroup1_info=models.IntegerField(
        ...
        label ='''How much are you willing to help a tournament participant in the Green Group?''')
    
    ingroup2_info=models.IntegerField(
        choices =list(range(7)), 
        widget = widgets.RadioSelectHorizontal,
        label ='''How much are you willing to help a tournament participant in the Blue Group?''')
    
    ingroup3_info=models.IntegerField(
        choices =list(range(7)), 
        widget = widgets.RadioSelectHorizontal,
        label ='''How much do you identify yourself with tournament participants in the Green Group?''')

    ingroup4_info=models.IntegerField(
        choices =list(range(7)), 
        widget = widgets.RadioSelectHorizontal,
        label ='''How much do you identify yourself with tournament participants in the Blue Group?''')
    ...
    smiley1= models.BooleanField(
        label='To tournament participant 1 (Green) ',
        widget= widgets.RadioSelect)

    smiley2= models.BooleanField(
        label='To tournament participant 2 (Green) ',
        widget= widgets.RadioSelect)

    smiley3= models.BooleanField(
        label='To tournament participant 3 (Green) ',
        widget= widgets.RadioSelect)

    smiley4= models.BooleanField(
        label='To tournament participant 4 (Blue)  ',
        widget= widgets.RadioSelect)

    smiley5= models.BooleanField(
        label='To tournament participant 5 (Blue)  ',
        widget= widgets.RadioSelect)

    smiley6= models.BooleanField(
        label='To tournament participant 6 (Blue)  ',
        widget= widgets.RadioSelect)
