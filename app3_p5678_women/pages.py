...
class p6a_SPECnSPECGwomen(Page):
    def is_displayed(self):
        if self.player.treatment == 'SPECG':
             return True
        else:
...
page_sequence = [p5_INFOwomen, p5_SPECGwomen, p6a_INFOwomen, p6a_SPECnSPECGwomen, attention_check1,
